...
eg.t3.dat$Treatment <- as.character(eg.t3.dat$Treatment)
eg.t3.dat[eg.t3.dat$Treatment == "C", 3] <- 0 
eg.t3.dat[eg.t3.dat$Treatment == "SL", 3] <- 1
...
eg.t3.dat_6$learnt[323:337] <- rep(1, 15)

eg.t3.dat_6[eg.t3.dat_6$LizardID == "1468460", 11]
